...
function showShippingMethodNew(objSelector, shipid, shipmethod, shipname, shipcheck) {
	var sHTML1 = '';

	sHTML1 += '<li class="' + shipmethod + '"><input type="radio" name="shipmethod_' + shipid + '" data-trackEvent="Shipping Option" value="' + shipmethod + '" id="' + shipmethod + shipid + '" ' + shipcheck + '>';
	sHTML1 += '<label for="' + shipmethod + '">' + shipname.replace("_",".") + '</label></li>';
